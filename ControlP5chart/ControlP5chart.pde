...
void setup() {
  ...
  myChart.addDataSet("set1");
  myChart.setData("set1", new float[100]);
...
void draw() {
  ...
  myChart.push("incoming", (cos(frameCount*0.1)*10));
  
  myChart.push("set1", (sin(frameCount*0.1)*10));
}
